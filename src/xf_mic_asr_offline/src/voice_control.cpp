...
int main(int argc, char *argv[])
{
	...
	ndHandle.param("source_path", source_path, std::string("/home/ucar/ucar_ws1/src/xf_mic_asr_offline"));
	ndHandle.param("/appid", appid, std::string("b1ab9a2d"));//appid，需要更换为自己的
