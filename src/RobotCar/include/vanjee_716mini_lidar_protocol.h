...
#include <RobotCar/vanjee_716mini_lidarConfig.h>
#include <set>
...
namespace vanjee_lidar
{
    ...
    public:
        ...
        bool setConfig(RobotCar::vanjee_716mini_lidarConfig &new_config, uint32_t level);
        bool heartstate_;

    private:
        RobotCar::vanjee_716mini_lidarConfig config_;
