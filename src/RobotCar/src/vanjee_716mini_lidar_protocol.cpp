#include "../include/vanjee_716mini_lidar_protocol.h"
...
namespace vanjee_lidar
{
    ...
    bool Vanjee716MiniLidarProtocol::setConfig(RobotCar::vanjee_716mini_lidarConfig &new_config, uint32_t level)
    {
        config_ = new_config;
