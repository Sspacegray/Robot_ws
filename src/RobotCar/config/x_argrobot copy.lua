...
-- 重要！减少TF跳变的关键参数
-- 建图时 
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.1  -- 减小以降低跳变
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.1  -- 增加采样率以提高回环检测机会
POSE_GRAPH.global_sampling_ratio = 0.001  
POSE_GRAPH.constraint_builder.max_constraint_distance = 15.0  -- 增加最大约束距离
POSE_GRAPH.constraint_builder.min_score = 0.55  -- 提高最小得分阈值，减少错误回环
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.6  -- 提高全局定位最小得分
