...
namespace vanjee_lidar
{
    ...
    public:
        Vanjee716MiniNode();
        ~Vanjee716MiniNode();
        void callback(vanjee_mini_lidar::vanjee_716mini_lidarConfig &config, uint32_t level);
        void connect();
    ...
    private:
        ...
        dynamic_reconfigure::Server<vanjee_mini_lidar::vanjee_716mini_lidarConfig> server_;
    };
