...
class carinfo(genpy.Message):
  _md5sum = "45c0e504be1d5153074c3d5b10d3b65d"
...
"""
  __slots__ = ['speed_x','speed_z','power']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3i().pack(_x.speed_x, _x.speed_z, _x.power))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.speed_x, _x.speed_z, _x.power,) = _get_struct_3i().unpack(str[start:end])
      return self
