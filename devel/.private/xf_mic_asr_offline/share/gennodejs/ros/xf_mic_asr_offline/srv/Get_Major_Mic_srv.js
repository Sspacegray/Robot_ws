...
class Get_Major_Mic_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.get_major_id, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.get_major_id = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '1a6fd49a0eb848a872f14b3f367c9378';
  }
...
module.exports = {
  ...
  md5sum() { return '68ec108b7ba6ff9867de0e21598a80d5'; },
